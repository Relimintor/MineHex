...
export const BLOCK_TYPES = [
    ...
    { name: 'Oak Wood', color: 0x5b3a24, roughness: 0.82, metalness: 0.0, capTexture: 'assets/hexes/log/oak/oak_log_top_bottom.png', capTextureScale: 1.165,capTextureOffset: { x: 0.0, y: 0.0121 } },
