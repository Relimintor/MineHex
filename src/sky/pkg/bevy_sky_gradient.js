/* @ts-self-types="./bevy_sky_gradient.d.ts" */
 ...
 * @returns {number}
 */
export function sky_color_hex(time_seconds) {
    const ret = wasm.sky_color_hex(time_seconds);
    return ret >>> 0;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./bevy_sky_gradient_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bevy_sky_gradient_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
